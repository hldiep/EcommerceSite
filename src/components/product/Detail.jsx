                        ...
                        {currentVariant.productImages.map((img, index) => (
                          <SwiperSlide key={index}>
                            <img
                              ...
                              className={`w-10 h-10 object-cover rounded border-2 cursor-pointer transition-transform duration-200 hover:scale-105 ${
                                activeIndex === index
                                  ? "border-red-500"
                                  : "border-transparent"
                              }`}
                ...
                <div className="md:w-1/2 space-y-4">
                  <div>
                    ...
                    {currentVariant ? (
                        ...
                        {currentVariant.priceSale ? (
                          <>
                            <p className="text-red-600 text-2xl font-bold">
                              {currentVariant.priceSale.toLocaleString()}₫
                            </p>
                      ...
                      <p className="text-gray-500">Chưa có giá</p>
                    )}
                  </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 mt-5">
                <div className="w-2/3">
                    ...
                    <div className="prose prose-sm max-w-none text-justify prose-img:rounded-xl">
                      {currentVariant?.description ? (
                        <ReactMarkdown rehypePlugins={[rehypeRaw]}>
                          {currentVariant.description.replace(/\\n/g, "\n")}
                        </ReactMarkdown>
                      ) : (
                        <p className="text-gray-500">
                          Chưa có mô tả cho phiên bản này
                        </p>
                      )}
                    </div>
                  </div>
                  <div className="mt-10" ref={specificationRef}>
                    ...
                    {currentVariant &&
                      Object.keys(currentVariant.specifications).length > 0 && (
                        <SpecificationTable
                          specifications={
                            typeof currentVariant.specifications === "string"
                              ? JSON.parse(currentVariant.specifications)
