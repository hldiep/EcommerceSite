...
const Chatbot = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const res = await fetchChatAICompare(recentMessages);
            const botMessage = { type: "bot", text: res || "Em chưa có câu trả lời ạ." };
    ...
    return (
        ...
        <AnimatePresence>
            ...
            >
                ...
                {loading && (
                    <div className="text-gray-500 text-sm italic">Đang xử lý...</div>
                )}
