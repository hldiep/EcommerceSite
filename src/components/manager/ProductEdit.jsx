        ...
        const loadProduct = async () => {
            try {
                ...
                setForm({
                    ...
                    optionIds: data.options ? data.options.map(o => o.id) : [],
            ...
            <div className="p-6 max-w-7xl mx-auto space-y-6 bg-gray-50 min-h-[calc(100vh-80px)]">
                <div className="sticky top-16 z-10 bg-white border-b shadow-sm">
                    <div className="flex items-center text-sm text-gray-600 space-x-2 px-4 pt-2">
                        ...
                        <span>/</span>
                        <span className="text-gray-700 font-medium">Chỉnh sửa sản phẩm</span>
                    </div>
                    <h2 className="text-xl font-semibold p-4">Chỉnh sửa sản phẩm</h2>
                </div>
                ...
                file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                                />
                                {isUploading && <p className="text-blue-600 text-sm mt-1">Đang tải ảnh lên...</p>}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1 mt-5">Thông số kỹ thuật</label>
                        <SpecificationsInput specifications={form.specifications} setSpecifications={setSpecifications} />
                    </div>

                    <button type="submit" disabled={loading} className="mt-5 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
...
const SpecificationsInput = ({ specifications, setSpecifications }) => {
    ...
    return (
        <div>
            ...
            <button type="button" onClick={handleAdd} className="bg-blue-600 text-white px-4 py-1 rounded">
                Thêm thuộc tính
            </button>
        </div>
    );
